...
<html <?php language_attributes(); ?>>
  ...
  <head>
    ...
    })(window,document,'script','dataLayer','GTM-N6RLF96');</script>
  ...
  <body <?php body_class(); ?>>
    ...
    <header id="header" class="">
      ...
      <div class="nav-wrap">
        <button id="primary-ham" class="hamburger hamburger--squeeze" type="button" aria-label="Menu" aria-controls="navigation">
